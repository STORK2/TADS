...
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.AddressType;
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.ContactInformationType;
...
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.LanguagesOfInstructionAndExaminationType;
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.LanguagesOfInstructionAndExaminationType.Language;
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.NameAndStatusOfAwardingInstitutionType;
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.NameAndStatusOfAwardingInstitutionType.AwardingInstitution;
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.NameAndStatusOfInstitutionAdministeringStudiesType;
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.NameAndStatusOfInstitutionAdministeringStudiesType.InstitutionAdministeringStudies;
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.QualificationType;
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.RichTextTagType;
import eu.stork.peps.complex.attributes.crue.academic.xsd.language.diplomasupplement.TitleConferredType;
