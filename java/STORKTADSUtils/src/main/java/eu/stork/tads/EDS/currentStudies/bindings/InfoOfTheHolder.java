...
import eu.stork.peps.complex.attributes.eu.stork.names.tc.stork._2_0.academic.generaldiploma.CountryTextCodeType;
import eu.stork.peps.complex.attributes.eu.stork.names.tc.stork._2_0.academic.generaldiploma.FamilyNameType;
import eu.stork.peps.complex.attributes.eu.stork.names.tc.stork._2_0.academic.generaldiploma.GivenNameType;
...
import eu.stork.peps.complex.attributes.eu.stork.names.tc.stork._2_0.academic.generaldiploma.InformationIdentifyingTheHolderOfTheQualificationType.Gender;
...
public class InfoOfTheHolder {
	...
	public JSONObject generate(InformationIdentifyingTheHolderOfTheQualificationType root){
		...
		try {
			...
			CountryTextCodeType countryOfBirth = root.getCountryOfBirth();
